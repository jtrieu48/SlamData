...
def updatePlayer():
    ...
    players = playerUpdate.updatePlayer(name, season, droundinput, dnumberInput, ageInput, ptsinput, rebinput, astinput)
    result = playerSearch.searchPlayerByName(players, name)
